...
- **Evidence:** Desktop and mobile browser captures, a combined reported-versus-corrected comparison, all-role checks at 390 × 844, a longest-label check at 320 × 800, zero console warnings/errors, passing static build, 8/8 sandbox and review-packet tests, and 4/4 static-host packaging tests in `design-qa.md`.
