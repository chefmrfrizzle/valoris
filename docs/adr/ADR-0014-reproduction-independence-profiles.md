...
| **I2 — Independent reproduction** | A different human reviewer outside the original author's control uses separate credentials and environment. Author implementation and data may be used and must be disclosed. |
| **I3 — Independent-implementation reproduction** | I2 plus an independently developed implementation of the declared method, with provenance showing it was not a repackaging of author code. |
...
Profile I2 would be the minimum label allowed to say "independently reproduced"
in Valoris product language. I1 must be described as second-environment
confirmation. Scientific acceptance and external validation remain separate
decisions even after I2 or I3 succeeds.
...
- I2 requires a qualified person outside the maintainer's control;
...
2. Conflict-of-interest and common-control rules have objective disclosure and
   escalation paths without collecting unnecessary personal data.
